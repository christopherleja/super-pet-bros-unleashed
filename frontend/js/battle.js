function renderBattle(playerPet, petObj){
    ...
    <h4 id="opponentHP">HP: ${opponent.hp} / ${opponentCopy.hp}</h4>
    `
    ...
    <h4 id="playerHP">HP: ${player.hp} / ${playerCopy.hp}</h4>
    `
...
function speedCheck(player, opponent, move_id){
